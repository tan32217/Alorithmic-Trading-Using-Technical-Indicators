# -*- coding: utf-8 -*-
"""
Created on Tue Sep 15 14:03:22 2020
...
tickers = ["HDFCBANK.NS","RELIANCE.NS","ASIANPAINT.NS","TCS.NS","ICICIBANK.NS","EICHERMOT.NS","CIPLA.NS"]
...
while len(tickers) != 0 and attempt <=300:
    ...
    for i in range(len(tickers)):
        try:
            ohlc_intraday[tickers[i]] = pdr.get_data_yahoo(tickers[i])
